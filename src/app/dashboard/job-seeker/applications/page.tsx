...
export default function ApplicationsPage() {
  ...
  return (
    <div className="space-y-6 lg:space-y-8">
      <section className="relative overflow-hidden rounded-[2rem] border border-white/80 bg-[linear-gradient(140deg,_rgba(15,23,42,0.95),_rgba(30,41,59,0.92)_45%,_rgba(8,145,178,0.88))] p-5 text-white shadow-[0_28px_80px_-45px_rgba(15,23,42,0.9)] lg:p-8">
        ...
        <div className="relative flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-200 lg:text-base">
              Filter your pipeline, keep tabs on recruiter engagement, and focus on
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
        {statusHighlights.map((item) => (
          <Card
            key={item.status}
            className="border-white/80 bg-white/90 shadow-[0_16px_36px_-28px_rgba(15,23,42,0.6)]"
          >
            <CardContent className="flex items-center gap-4 p-4">
              <div className={cn("flex h-12 w-12 items-center justify-center rounded-2xl ring-1", item.tone)}>
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="relative max-w-xl flex-1">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-3 pl-11 pr-4 text-sm text-slate-900 outline-none transition focus:border-sky-300 focus:bg-white focus:ring-2 focus:ring-sky-100"
              />
            </div>
