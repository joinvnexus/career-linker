...
export function HomeCareerTipsSection() {
  ...
  return (
    <section className="bg-white/60 py-16 sm:py-18 lg:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
          <Link
            ...
            className="group overflow-hidden rounded-[2rem] bg-slate-950 p-6 text-white shadow-[0_30px_80px_-40px_rgba(15,23,42,0.75)] sm:p-8"
          >
